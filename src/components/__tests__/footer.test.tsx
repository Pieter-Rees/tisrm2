...
describe('Footer', () => {
  ...
  it('displays company information', () => {
    ...
    const logoElement = screen.getByText('TIS Risk Management', {
      selector: '.logo',
    });
  ...
  it('has correct navigation link attributes', () => {
    ...
    expect(verzekeringenLink.closest('a')).toHaveAttribute(
      'href',
      '/verzekeringen',
    );
